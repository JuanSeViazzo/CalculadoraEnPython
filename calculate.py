...
ventana = Tk()
ventana.title("Calculadora Js")
#ventana.geometry('300x400')
#etiqueta = tkinter.Label(ventana, text = "By Juan S", bg="LightBlue")
#etiqueta.pack(side= tkinter.BOTTOM)
#Con tkinter.Both (hago eje X y eje Y por lo cual ocupa todo el progm)
#etiqueta.pack(fill=tkinter.X, side=tkinter.BOTH)



#entrada de texto (widget)
...
boton_igual = Button(ventana, text = "=", width = 5, height = 2, command= lambda: calcularOperacion())
